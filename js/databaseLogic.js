...
export function createDatabase(logger) {
    ...
    db.serialize(function () {
        ...
        db.run("CREATE TABLE if not exists Users (id INTEGER NOT NULL PRIMARY KEY, username TEXT UNIQUE NOT NULL , name TEXT, lastname TEXT, passwordhash TEXT, power NOT NULL INTEGER, level NOT NULL INTEGER, token text, admin integer)");
